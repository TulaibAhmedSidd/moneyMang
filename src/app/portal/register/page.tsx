...
export default function UserRegisterPage() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Automatically log in on successful registration and redirect to dashboard
      let token = result.data?.token;
      let user = result.data?.user;

      if (!token || !user) {
        // Fallback auto-login call
      ...
      // Always go directly to portal dashboard, never login page!
